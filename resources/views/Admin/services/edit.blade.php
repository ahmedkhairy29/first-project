...
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6>messages.services.edit_title</h6>
            <a href="{{ route('admin.services.index') }}" class="btn btn-secondary btn-sm">messages.services.back_to_index</a>
        </div>
...
<div class="mb-3">
    ...
    <input type="text" name="description_ar" class="form-control" placeholder="خطط لمسارات فعالة..." value="{{ old('description_ar', $service->description_ar) }}">
                ...
                <button type="submit" class="btn btn-primary">messages.services.submit_update </button>
            </form>
        </div>
    </div>
</div>
